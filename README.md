...
Odpowiedź:  Program powoduje zmianę stanu diody L (wbudowanej w płytkę)
...
Odpowiedź:  Zwiększa się czas świecenia

## Zadanie 2-3-1:
Pytanie:    *Jakie niedogodności z punktu widzenia kierowców są obecne w programie sterującym światłami?*  
Odpowiedź:  Nagłe zmiany stanów światel, co powoduje gwałtowne hamowanie kierowcy

## Zadanie 2-3-2:
Pytanie:    *Czy możliwe jest sterowanie stanem niskim (LOW) diod LED?*  
Odpowiedź:  Tak jest możliwe, należy odpowiednio zdefiniować porty
